...
| `compute/`    | `image_builder`   | EC2 Image Builder pipeline: inline or existing components, content-hashed immutable recipes, multi-region distribution, private, account-shared, or public AMIs, and on-demand builds started by a deploy step (includes `rvn-aws-image-builder` module definition) | Unreleased |
...
| `rvn-aws-image-builder` | EC2 Image Builder | v0.2.0 | `compute/image_builder/` |
