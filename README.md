...
| `compute/`    | `eks`             | Composite EKS stack: cluster, 2–4 node default capacity, CoreDNS, optional Fargate, private ARM SSM relay, integration/egress-restricted runtime read/admin roles, and a separate provisioning Runner role (includes `rvn-eks-cluster` module definition) | Unreleased |
