...
| `rvn-ec2-service` | EC2 Service | v1.4.3 | `compute/ec2_service/` |
| `rvn-ecs-cluster` | ECS Cluster | v1.0.2 | `compute/ecs_cluster/` |
| `rvn-ecs-nlb` | ECS Network Service | v1.1.3 | `compute/ecs_service/` |
| `rvn-ecs-web` | ECS Web Service | v1.1.2 | `compute/ecs_service/` |
| `rvn-ecs-worker` | ECS Worker | v1.1.2 | `compute/ecs_service/` |
...
| `rvn-eks-web` | EKS Web Service | v1.0.1 | `compute/eks_service/` |
