...
| `compute/`    | `eks`             | Composite EKS stack: cluster, 2–4 node default capacity, CoreDNS, optional Fargate, and a dedicated private ARM SSM relay with separate read/deploy access roles (includes `rvn-eks-cluster` module definition) | Unreleased |
