...
{{- define "rvn-eks-cron.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Fully qualified release name. */}}
{{- define "rvn-eks-cron.fullname" -}}
...
{{- define "rvn-eks-cron.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Selector labels. Immutable across upgrades — never add anything volatile. */}}
{{- define "rvn-eks-cron.selectorLabels" -}}
app.kubernetes.io/name: {{ include "rvn-eks-cron.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "rvn-eks-cron.labels" -}}
helm.sh/chart: {{ include "rvn-eks-cron.chart" . }}
{{ include "rvn-eks-cron.selectorLabels" . }}
...
*/}}
{{- define "rvn-eks-cron.serviceAccountName" -}}
{{- default (include "rvn-eks-cron.fullname" .) .Values.serviceAccount.name -}}
{{- end -}}

{{/* Name of the Kubernetes Secret materialized by the ExternalSecret. */}}
{{- define "rvn-eks-cron.secretName" -}}
{{- printf "%s-secrets" (include "rvn-eks-cron.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* Container image reference. A digest, when supplied, wins over the tag. */}}
{{- define "rvn-eks-cron.image" -}}
...
- name: {{ .name }}
  valueFrom:
    secretKeyRef:
      name: {{ include "rvn-eks-cron.secretName" $ }}
      key: {{ .name }}
{{- end }}
{{- end -}}
