...
| load_balancer_name_prefix | Prefix for the shared load balancer and security group names (`<prefix>-pub`, `<prefix>-priv`, `<prefix>-pub-nlb`, `<prefix>-priv-nlb`); defaults to `<cluster_name>-eks`. Up to 23 characters. | `string` | `null` | no |
